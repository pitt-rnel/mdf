function [res, ed] = validateRelationships(obj)
    ...
    pipeline = { ...
     ...
     '{ $project : { "mdf_p1_uuid" : "$mdf_uuid", "mdf_p1_type" : "$mdf_type", "mdf_p1_field" : "$mdf_child_field", "mdf_c1_uuid" : "$mdf_child_values.mdf_uuid", "mdf_c1_type" : "$mdf_child_values.mdf_type" } }', ...
     [ '{ $lookup : { ' ...
        'from : "mdfDbTest", ' ...
    ...
    pipeline = { ...
     ...
     '{ $project: { "mdf_c1_uuid": 1, "mdf_c1_type": 1, "mdf_p1_uuid": 1, "mdf_p1_type": 1 }}', ...
     ['{ $lookup : {' ...
       'from: "mdfDbTest",' ...
       'let: { c_uuid : "$mdf_c1_uuid", c_type : "$mdf_c1_type", p_uuid : "$mdf_p1_uuid", p_type : "$mdf_p1_type" },' ...
       'pipeline: [ ' ... 
    ...
    if nargout > 1
        ed = struct( ...
            'parentChild', struct( ...
                 'missingChildObject', pcMco, ...
                 'missingParentObject', pcMpo, ...
                 'missingChildParentRef', pcMcpr, ...
                 'missingParentChildRef', pcMpcr  ...
            ), ...
            'bidirectionalLink' , struct( ...
                 'missingDestObject', blMdo, ...
                 'missingDestSourceRef', blMdsr ...
            ), ...
            'unidirectionlLink' , struct( ...
                 'missingDestObject', ulMdo ...
            )  ...
        );
