function [D J] = parseJsonValue(obj,J)
    % [D J] = rfConf.parseJsonValue(obj,json)
    %
    ...
    switch lower(id)
        ...
        case 't'
            ...
            if (length(J) >= 3)
                ...
                ME = MException('rfConf:parseJsonValue',['Invalid TRUE identifier: ' id J]);
                ME.throw;
            end
        ...
        case 'f'
            ...
            if (length(J) >= 4)
            	...
            	ME = MException('rfConf:parseJsonValue',['Invalid FALSE identifier: ' id J]);
            	ME.throw;
            end
        ...
        case 'n'
            ...
            if (length(J) >= 3)
            	...
            	ME = MException('rfConf:parseJsonValue',['Invalid NULL identifier: ' id J]);
            	ME.throw;
            end
